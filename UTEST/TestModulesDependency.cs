...
namespace UTEST
{
    ...
    public class TestModulesDependency
    {
        ...
        [TestMethod]
        public void CreateFunctionDependencyFromScratchTest()
        {
            ...
            Assert.AreEqual(modulIDsList[0].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[0]))),true);
            Assert.AreEqual(modulIDsList[1].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[1]))),true);
            Assert.AreEqual(modulIDsList[2].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[2]))),true);
            Assert.AreEqual(modulIDsList[3].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[3]))),true);
            Assert.AreEqual(modulIDsList[4].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[4]))),true);
            Assert.AreEqual(modulIDsList[5].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[5]))),true);
            Assert.AreEqual(modulIDsList[6].SetEquals(new HashSet<int>(obj.GetTouchedModules(funcNamesList[6]))),true);    
        }

        [TestMethod]
        public void CreateFunctionDependencyFromFile()
        {
            var funcNamesList = new List<string>{"f11", "f12", "f21", "f22", "f23", "f31", "f32"};
            var modulIDsList = new List<HashSet<int>>{
                new HashSet<int>{11},
